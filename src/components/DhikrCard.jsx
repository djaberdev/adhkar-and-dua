    ...
    return dhikrObject.category !== "stop" && (
        ...
        >
            ...
            <div className="relative flex flex-col p-6">
                ...
                <div className={clsx("bg-primary-green/90 p-2 rounded-full flex items-center gap-2 mt-6 duration-500 cursor-auto", isInfoOpen && "mb-5")}>
                    <button
                ...
                <div className={clsx("bg-secondary-green/25 rounded-lg border-b-0 border-secondary-green/30 shadow-sm transition-all duration-500", isInfoOpen ? "h-auto scale-y-100 p-4 border-2 opacity-100 visible" : "h-0 scale-y-0 p-0 border-0 opacity-0 invisible")}>
